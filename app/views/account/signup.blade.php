...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" action="{{ URL::route('account-postregister') }}" method="post">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-6"><a href="{{URL::route('account-login')}}" class="btn btn-success btn-block btn-lg">Sign In</a></div>
			</div>
		{{Form::token() }}
		</form>
	</div>
 ...
 <p class="text-center" style="margin-top:10px;">OR</p>
				    <a class="btn btn-lg btn-block" href="#"><i class="icon-facebook"></i> Register with Facebook</a>
				  	<br>
<!-- Modal -->
